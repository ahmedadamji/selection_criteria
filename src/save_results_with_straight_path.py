...
with open("/root/catkin_ws/src/project_ws/catkin_ws/src/data/KITTI/06/results/06_gt_tum") as odometries:
...
for file_num in range(len(sys.argv)-1):
    ...
    # path: "/root/catkin_ws/src/project_ws/catkin_ws/src/data/KITTI/06/results/" + est_file_name + ".tum"

    with open("/root/catkin_ws/src/project_ws/catkin_ws/src/data/KITTI/06/results/" + est_file_name + ".tum") as odometries:
        for odometry in odometries:
            # Open a file with access mode 'a'
