...
int main (int argc, char** argv)
{
  ...
  // message_filters::Subscriber<sensor_msgs::PointCloud2> c1(nh, "/rs16_tc/rslidar_points", 1); //check if anything is even published to filtered points
  // message_filters::Subscriber<sensor_msgs::PointCloud2> c2(nh, "/rs16_tc/rslidar_points", 1);
