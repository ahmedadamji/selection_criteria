...
The results are saved in the data folder, inside the src folder of the workspace. The results recorded for this project are made available at the following link: [data](). This can be downloaded to evaluated the recorded trajectories, else the file structure may be copied if needed to record your own trajectories for evauation.  
